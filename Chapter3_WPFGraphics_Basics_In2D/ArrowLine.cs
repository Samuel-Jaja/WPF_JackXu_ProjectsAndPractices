...
namespace Chapter3_WPFGraphics_Basics_In2D
{
 ...
 FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        public double ArrowheadSizeX
        {
            ...
            {
                return
            (double)GetValue(ArrowheadSizeXProperty);
            }
        }
        // Specify the arrowhead size in the y direction: 
        public static readonly DependencyProperty ArrowheadSizeYProperty = DependencyProperty.Register("ArrowheadSizeY", typeof(double), typeof(ArrowLine),new FrameworkPropertyMetadata(10.0,FrameworkPropertyMetadataOptions.AffectsMeasure));
        public double ArrowheadSizeY
        {
            ...
            {
                return
            (double)GetValue(ArrowheadSizeYProperty);
            }
        }

        // Specify arrowhead ends: 
        public static readonly DependencyProperty ArrowheadEndProperty = DependencyProperty.Register("ArrowheadEnd",typeof(ArrowheadEndEnum), typeof(ArrowLine),new FrameworkPropertyMetadata(ArrowheadEndEnum.End,FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        public ArrowheadEndEnum ArrowheadEnd
        {
            ...
            {
                return
            (ArrowheadEndEnum)GetValue(ArrowheadEndProperty);
            }
        }
        ...
        public bool IsArrowheadClosed
        {
            set
            {
                SetValue(IsArrowheadClosedProperty,
            value);
            }
            get
            {
                return
            (bool)GetValue(IsArrowheadClosedProperty);
            }
        }
        ...
        PathFigure CreateArrowhead(PathFigure pathFigure, Point pt1, Point pt2)
        {
            ...
            //{
            //    v = (Vector)new Point(0, 0) – new Point(ArrowheadSizeX / 2, ArrowheadSizeY);
            //    pt = pt2 + v * m;
            //    pathFigure.StartPoint = pt;
            //    pls1.Points.Add(pt2);
            //    v = (Vector)new Point(0, 0) – new Point(-ArrowheadSizeX / 2,
            //    ArrowheadSizeY);
            //    pt = pt2 + v * m;
            //    pls1.Points.Add(pt);
            //}
            ...
            //{
            //    v = (Vector)new Point(0, 0) – new Point(ArrowheadSizeX / 2, 0);
            //    pt = pt2 + v * m;
            //    pathFigure.StartPoint = pt;
            //    v = (Vector)new Point(0, 0) – new Point(0, -ArrowheadSizeY);
            //    pt = pt2 + v * m;
            //    pls1.Points.Add(pt);
            //    v = (Vector)new Point(0, 0) – new Point(-ArrowheadSizeX / 2, 0);
            //    pt = pt2 + v * m;
